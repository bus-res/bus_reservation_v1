...
<body>
	<form action="changepwd.bus" method="post">
		<table>
		<tr>
			...
			<tr>
				...
				<td><input type="text" class="textfields" name="contact"></td>
			</tr>
			<tr>
				<td>New Password</td>
				<td>:</td>

				<td><input type="text" class="textfields"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" class="textfields" name="password"></td>
			</tr>
			<tr>
				<td colspan=4><br></td>
			</tr>
